...
public class UserAuthentication {
    private static final String PROPERTIES_FILE = "/Users/Admin/IdeaProjects/NoteApp/database/users.properties";
        ...
        if(username.length() < 1 || password.length() < 1){
            ...
            if (properties.containsKey(username)) {
                ...
                if (password.equals(confirm)) {
                    ...
                    new File("/Users/Admin/IdeaProjects/NoteApp/database/UsersData/" + username).mkdir();
                    return 1;
                } else {
                    return -2;
                }
